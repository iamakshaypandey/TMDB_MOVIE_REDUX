...
import '../../Container/myStyle.css'
// import { MainBar } from '../../Container/Main'
    ...
    return (
        <>
            <nav className="navbar navbar-expand-lg bg-color-nav navbar-light">
                ...
                <img src={''} alt="brand" className='w-50 h-50' />
                </Link>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul className="navbar-nav ml-auto">
                        <li className="nav-item  active">
                            <Link className="nav-link text-white h6 m-3 btn-outline-info" to='PopulerMovies' >Populer Movies</Link>    
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link text-white h6 m-3 btn-outline-info" to='TopRatedMovies' >Top Rated</Link>
                        </li>
                    </ul>
                </div>
            </nav>
